...
int main() {
	...
	digit1 = digit1 + 7 > 10 ? (digit1 + 7) % 10 : digit1 + 7;
	digit2 = digit2 + 7 > 10 ? (digit2 + 7) % 10 : digit2 + 7;
	digit3 = digit3 + 7 > 10 ? (digit3 + 7) % 10 : digit3 + 7;
	digit4 = digit4 + 7 > 10 ? (digit4 + 7) % 10 : digit4 + 7;
